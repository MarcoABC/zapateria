...
class color extends db_object{
    public static $db_tabla = "tcolor"; 
    public static $db_campos_tabla = array('id', 'nombre');
    public $id;
    public $nombre;
    ...
    public static function contar_colores_deshabilitados(){
    ...
    public static function buscar_colores_habilitados($word){
        return static::query("SELECT * FROM ".static::$db_tabla. " WHERE id LIKE '%".$word."%' 
        OR nombre LIKE '%".$word."%' AND estado = 0");
    }

    public static function buscar_colores_deshabilitados($word){
        return static::query("SELECT * FROM ".static::$db_tabla. " WHERE id LIKE '%".$word."%' 
