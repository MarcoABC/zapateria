<?php
class categoria extends db_object{
    public static $db_tabla = "tcategoria"; //Variable para manejar la tabla
    ...
    public static function traer_nombre_categorias(){
        return static::query("SELECT LOWER(nombre) as nombre FROM ".static::$db_tabla);    
    }

    public static function traer_categorias_habilitadas(){
        return static::query("SELECT * FROM ".static::$db_tabla." WHERE estado = 0");    
    }

    public static function traer_categorias_deshabilitadas(){
        return static::query("SELECT * FROM ".static::$db_tabla." WHERE estado = 1");    
    }

    public static function contar_categorias_habilitadas(){
    ...
    public static function contar_categorias_deshabilitadas(){
